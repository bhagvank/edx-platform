...
def do_email_change_request(user, new_email, activation_key=None, secondary_email_change_request=False):
    ...
    if secondary_email_change_request:
        ...
        confirm_link = reverse('confirm_secondary_email_changed', kwargs={'key': activation_key,})
    else:
...
@ensure_csrf_cookie
def confirm_secondary_email_changed(request, key):  # pylint: disable=unused-argument
