...
class DataDownloadsTestWithMultipleRoles(BaseInstructorDashboardTest):
    ...
    def test_list_student_profile_information(self, role):
        ...
        data_download_section.generate_enrolled_student_profile_button.click()
    ...
    def test_list_student_profile_information_for_large_course(self, role):
        ...
        self.assertTrue(data_download_section.check_enrolled_student_profile_button_presence)
        LogoutPage(self.browser).visit()
        for __ in range(5):
        ...
        self.assertFalse(data_download_section.check_enrolled_student_profile_button_presence)
